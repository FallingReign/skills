...
BRAND_BG_ALT = "0b1524"
BRAND_TEXT = "f2f6ff"
BRAND_TEXT_SECONDARY = "e2ecff"
BRAND_ACCENT = "5dd7ff"
BRAND_ACCENT_SECONDARY = "7ef0ff"
BRAND_ACCENT_TERTIARY = "2e84ff"
BRAND_CARD_BG = "142238"
BRAND_CODE_BG = "11111b"
BRAND_HEADING_FONT = "Space Grotesk"
BRAND_BODY_FONT = "Plus Jakarta Sans"
...
def create_code_slide(prs):
    ...
    code_bg.line.color.rgb = hex_to_rgb("142238")

    # Terminal dots
    for i, color in enumerate(["2e84ff", "5dd7ff", "7ef0ff"]):
...
def create_circular_hero_slide(prs):
    ...
    outer.line.color.rgb = hex_to_rgb("142238")
...
def create_image_caption_slide(prs):
    ...
    placeholder.line.color.rgb = hex_to_rgb("142238")
